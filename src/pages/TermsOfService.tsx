      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="prose prose-invert prose-cyan max-w-none space-y-6 text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <p>
              By accessing and using ZipPix, you accept and agree to be bound by
          ...
          <section className="space-y-4">
            ...
            <p>
              ZipPix is a free, client-side image compression tool. The service
              allows you to:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Compress images in various formats (JPEG, PNG, WebP, AVIF)
              </li>
          ...
          <section className="space-y-4">
            ...
            <p>
              You retain all rights to your images. ZipPix does not claim any
              ownership or rights to images you process using our service. The
              ZipPix software, branding, and design are owned by the project
              maintainers.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ZipPix is provided "as is" without warranties of any kind, express
          ...
          <section className="space-y-4">
            ...
            <p>
              ZipPix and its maintainers shall not be liable for any direct,
